...
writeFileSync("upsample.js", /* javascript */`
...
export default function(){
  ...
  s16.forEach((v,i)=> fl[i]=v/0xffff)
	...
	const ratio=instance.exports.setRatio(ref, sampleRate+1.0000001,Math.pow(2,(pitch-69)/12)*440.0);
	const done=instance.exports.upsample_wave_table(ref);
  if(done) return new Float32Array(heap.buffer, output, 4096);
	else yield new Float32Array(heap.buffer, output, 4096);
  }
}`);